    ...
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='mt-20'>
        ...
        <div className='flex flex-col gap-4 border border-gray-400 px-6 py-6 text-sm text-gray-500'>
          <p>An e-commerce website is an online platform that facilitates the buying and selling product</p>
           <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Corporis, necessitatibus autem aliquam, impedit quo consequuntur minima vero repellendus, quisquam eum iste quae sunt tempore officiis dolore. Nam rem impedit consectetur.</p>
        </div>
      </div>
